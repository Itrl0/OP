namespace OP
{
    partial class recipe8
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(recipe8));
            back = new Button();
            ...
            listBox2.Items.AddRange(new object[] { "1)Почистіть картоплю і наріжте її тонкими брусочками.", "2)Замочіть картоплю в холодній воді на 20 хвилин, щоб ", "вийшов крохмаль.", "3)Обсушіть картоплю паперовим рушником.", "4)Розігрійте багато олії в глибокій сковороді або ", "фритюрниці.", "5)Обсмажте картоплю порціями до золотистої скоринки.", "6)Вийміть картоплю на паперовий рушник, посоліть і", " подавайте гарячою." });
            ...
            label1.TabIndex = 58;
            label1.Text = "Назва: Смажена картопля фрі\n";
            // 
            // pictureBox1
            // 
            ...
            listBox1.Items.AddRange(new object[] { "Картопля – 3–4 шт.", "Олія ", "Сіль", "Соус" });
