namespace OP
{
    partial class recipe18
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(recipe18));
            label3 = new Label();
            ...
            listBox2.Items.AddRange(new object[] { "1)Наріжте огірки, помідори, цибулю та перець", " невеликими кубиками.", "2)Складіть усі овочі в одну велику миску.", "3)Посоліть овочі і заправте олією.", "4)Добре перемішайте салат ложкою.", "5)За бажанням додайте трохи зелені.", "6)Подавайте салат охолодженим." });
            listBox2.Location = new Point(7, 307);
            listBox2.Name = "listBox2";
            listBox2.Size = new Size(516, 220);
            listBox2.TabIndex = 122;
            // 
            // label2
            // 
            ...
            label1.TabIndex = 120;
            label1.Text = "Назва:  Салат зі свіжих овочів";
            // 
            // pictureBox1
            // 
            ...
            listBox1.Items.AddRange(new object[] { "Огірок – 1 шт.", "Помідор – 2 шт.", "Цибуля – 1 шт.", "Перець – 1 шт.", "Олія", "Сіль" });
            listBox1.Location = new Point(329, 78);
            listBox1.Name = "listBox1";
            listBox1.Size = new Size(208, 182);
            listBox1.TabIndex = 118;
            // 
            // back
            // 
