namespace OP
{
    partial class recipe19
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(recipe19));
            label3 = new Label();
            ...
            listBox2.Items.AddRange(new object[] { "1)Промийте рис кілька разів у холодній воді.", "2)Відваріть рис до готовності та відкиньте на друшляк.", "3)Наріжте моркву, цибулю та перець кубиками.", "4)Обсмажте овочі на олії до м'якості.", "5)Додайте рис до овочів і добре перемішайте зі спеціями.", "6)Прогрійте все разом ще 3–5 хвилин і подавайте." });
            listBox2.Location = new Point(4, 307);
            listBox2.Name = "listBox2";
            listBox2.Size = new Size(516, 220);
            listBox2.TabIndex = 130;
            // 
            // label2
            // 
            ...
            label1.TabIndex = 128;
            label1.Text = "Назва:  Рис з овочами";
            // 
            // pictureBox1
            // 
            ...
            listBox1.Items.AddRange(new object[] { "Рис", "Морква – 1 шт.", "Перець – 1 шт.", "Цибуля – 1 шт.", "Олія", "Спеції " });
            listBox1.Location = new Point(326, 78);
            listBox1.Name = "listBox1";
            listBox1.Size = new Size(208, 182);
            listBox1.TabIndex = 126;
            // 
            // back
            // 
            ...
            button3.Location = new Point(285, 541);
            ...
            button2.Location = new Point(152, 541);
