namespace OP
{
    partial class recipe2
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(recipe2));
            back = new Button();
            ...
            back.Location = new Point(12, 543);
            back.Name = "back";
            ...
            next_Page.Location = new Point(429, 543);
            next_Page.Name = "next_Page";
            next_Page.Size = new Size(99, 39);
            next_Page.TabIndex = 19;
            next_Page.Text = "Далі";
            ...
            label3.Location = new Point(152, 275);
            label3.Name = "label3";
            ...
            listBox2.Items.AddRange(new object[] { "1)Відваріть картоплю, моркву і яйця до готовності, остудіть.", "2)Все наріжте дрібними кубиками.", "3)Додайте нарізану ковбасу, огірки, горошок.", "4)Перемішайте інгредієнти у великій мисці.", "5)Заправте майонезом, посоліть і перемішайте ще раз.", "6)Поставте в холодильник на 30 хвилин для просочення." });
            listBox2.Location = new Point(5, 333);
            listBox2.Name = "listBox2";
            listBox2.Size = new Size(530, 176);
            ...
            listBox1.Items.AddRange(new object[] { "Картопля – 3 шт.", "Морква – 2 шт.", "Яйця – 4 шт.", "Ковбаса – 1 авлка", "Огірки – 2–3 шт.", "Горошок –1 банка", "Соус " });
            listBox1.Location = new Point(334, 75);
            listBox1.Name = "listBox1";
            listBox1.Size = new Size(217, 182);
            ...
            button3.Location = new Point(285, 543);
            ...
            // cook
            // 
            cook.ForeColor = Color.Black;
            cook.Location = new Point(334, 278);
            cook.Name = "cook";
