namespace OP
{
    partial class recipe15
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(recipe15));
            label3 = new Label();
            ...
            label3.Location = new Point(147, 275);
            label3.Name = "label3";
            ...
            listBox2.Items.AddRange(new object[] { "1)Збийте яйця з цукром та дрібкою солі.", "2)Додайте молоко і просіяне борошно, ретельно ", "перемішайте до однорідної маси.", "3)Додайте трохи олії у тісто.", "4)Нагрійте сковорідку і змастіть її тонким шаром олії.", "5)Виливайте порції тіста, розподіляючи тонким шаром.", "6)Обсмажуйте млинці з обох боків до золотистого кольору." });
            listBox2.Location = new Point(8, 307);
            ...
            label1.TabIndex = 104;
            label1.Text = "Назва: Млинці";
            // 
            // pictureBox1
            // 
            pictureBox1.Image = (Image)resources.GetObject("pictureBox1.Image");
            pictureBox1.Location = new Point(24, 78);
            ...
            listBox1.Items.AddRange(new object[] { "Молоко", "Яйця – 2 шт.", "Борошно", "Цукор", "Сіль", "Олія" });
            listBox1.Location = new Point(330, 78);
            ...
            back.Location = new Point(17, 541);
            back.Name = "back";
            ...
            next_Page.Location = new Point(422, 541);
            ...
            button3.Location = new Point(290, 541);
            ...
            button2.Location = new Point(157, 541);
            ...
            // cook
            // 
            cook.Location = new Point(330, 278);
            cook.Name = "cook";
