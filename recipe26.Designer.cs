namespace OP
{
    partial class recipe26
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(recipe26));
            label3 = new Label();
            ...
            label3.Location = new Point(146, 275);
            label3.Name = "label3";
            ...
            listBox2.Items.AddRange(new object[] { "1)Замісіть тісто з борошна, яйця, води, дрібки солі.", "2)Розкачайте тісто в тонкий пласт і викладіть на деко.", "3)Змастіть основу соусом і рівномірно розкладіть начинку: ", "ковбасу, сир.", "4)Можна додати ще огірок чи інші улюблені інгредієнти.", "5)Запікайте у розігрітій духовці при 200°C близько 15", " хвилин.", "6)Подавайте гарячу піцу зі свіжою зеленню." });
            listBox2.Location = new Point(7, 307);
            listBox2.Name = "listBox2";
            listBox2.Size = new Size(516, 220);
            listBox2.TabIndex = 178;
            // 
            // label2
            // 
            ...
            listBox1.Items.AddRange(new object[] { "Борошно ", "Яйце – 1 шт.", "Сіль", "Соус ", "Ковбаса ", "Сир ", "Печериці - 4 шт." });
            listBox1.Location = new Point(329, 78);
            listBox1.Name = "listBox1";
            listBox1.Size = new Size(208, 182);
            listBox1.TabIndex = 174;
            // 
            // back
            // 
            ...
            back.Location = new Point(16, 541);
            back.Name = "back";
            ...
            next_Page.Location = new Point(421, 541);
            next_Page.Name = "next_Page";
            next_Page.Size = new Size(99, 39);
            next_Page.TabIndex = 172;
            next_Page.Text = "Далі";
            ...
            button3.Location = new Point(295, 541);
            button3.Name = "button3";
            button3.Size = new Size(99, 39);
            button3.TabIndex = 181;
            ...
            button2.Location = new Point(162, 541);
            ...
            // cook
            // 
            cook.Location = new Point(326, 278);
            cook.Name = "cook";
