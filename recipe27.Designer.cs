namespace OP
{
    partial class recipe27
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(recipe27));
            label3 = new Label();
            ...
            listBox2.Items.AddRange(new object[] { "1)Насипте цукор у суху сковорідку або каструлю.", "2)Підігрівайте на середньому вогні, постійно помішуючи.", "3)Коли цукор повністю розплавиться і стане карамельним, ", "зніміть з вогню.", "4)Швидко влийте у формочки або сформуйте ложкою на", " пергаменті.", "5)Якщо хочете, вставте палички в серединку карамелі.", "6)Дайте льодяникам застигнути при кімнатній температурі." });
            listBox2.Location = new Point(10, 307);
            listBox2.Name = "listBox2";
            listBox2.Size = new Size(516, 220);
            listBox2.TabIndex = 186;
            // 
            // label2
            // 
            ...
            label1.TabIndex = 184;
            label1.Text = "Назва: Карамель на паличці";
            // 
            // pictureBox1
            // 
            ...
            pictureBox1.Size = new Size(248, 201);
            ...
            back.Location = new Point(19, 541);
            back.Name = "back";
            ...
            next_Page.Location = new Point(424, 541);
            next_Page.Name = "next_Page";
            next_Page.Size = new Size(99, 39);
            next_Page.TabIndex = 180;
            next_Page.Text = "Далі";
            ...
            button3.Location = new Point(291, 541);
            ...
            button2.Location = new Point(158, 541);
            ...
            // cook
            // 
            cook.Location = new Point(329, 278);
            cook.Name = "cook";
