namespace OP
{
    partial class recipe11
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(recipe11));
            back = new Button();
            ...
            listBox2.Items.AddRange(new object[] { "1)Сформуйте з фаршу котлету і обсмажте її на сковороді або ", "грилі.", "2)Розріжте булочку навпіл і трохи підрум'яньте зрізи на ", "сковороді.", "3)На нижню частину булочки викладіть лист салату.", "4)Потім покладіть котлету, шматочок сиру, кружечок огірка, ", "помідора та кільця цибулі.", "5)Накрийте верхньою частиною булочки.", "6)За бажанням додайте улюблений соус перед складанням." });
            listBox2.Location = new Point(7, 307);
            listBox2.Name = "listBox2";
            listBox2.Size = new Size(516, 220);
            listBox2.TabIndex = 78;
            // 
            // label2
            // 
            ...
            listBox1.Items.AddRange(new object[] { "Булочки – 2 шт.", "Фарш – 2 шт.", "СирОгірок – 1 шт.", "Помідор – 1 шт.", "Цибуля – 1 шт.", "Салат – 4 листки" });
            listBox1.Location = new Point(329, 78);
            listBox1.Name = "listBox1";
            listBox1.Size = new Size(194, 182);
            listBox1.TabIndex = 74;
            // 
            // button3
            // 
            ...
            // cook
            // 
            cook.Location = new Point(371, 278);
            cook.Name = "cook";
