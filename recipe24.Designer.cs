namespace OP
{
    partial class recipe24
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(recipe24));
            label3 = new Label();
            label2 = new Label();
            label1 = new Label();
            ...
            label1.TabIndex = 160;
            label1.Text = "Назва: Смажена риба";
            // 
            // pictureBox1
            // 
            ...
            pictureBox1.Size = new Size(289, 201);
            ...
            listBox1.Items.AddRange(new object[] { "Риба – 2 шматки", "Сіль", "Борошно", "Олія " });
            listBox1.Location = new Point(329, 78);
            listBox1.Name = "listBox1";
            listBox1.Size = new Size(208, 182);
            listBox1.TabIndex = 158;
            // 
            // back
            // 
            ...
            button2.Location = new Point(143, 541);
            ...
            button3.Location = new Point(276, 541);
            ...
            listBox2.Items.AddRange(new object[] { "1)Наріжте рибу порційними шматками.", "2)Посоліть і поперчіть шматки риби.", "3)Обкачайте рибу в борошні.", "4)Розігрійте олію на сковороді.", "5)Обсмажуйте рибу з обох боків до рум’яної скоринки.", "6)Подавайте гарячою з лимоном або зеленню." });
