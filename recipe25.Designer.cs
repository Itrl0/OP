namespace OP
{
    partial class recipe25
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(recipe25));
            label3 = new Label();
            ...
            label3.Location = new Point(145, 275);
            label3.Name = "label3";
            ...
            listBox2.Items.AddRange(new object[] { "1)Наріжте м'ясо невеликими шматочками й обсмажте на", "сковороді до готовності.", "2)Нашаткуйте салат, огірок і натріть сир на тертці.", "3)Розкладіть лаваш на столі й змастіть соусом.", "4)Викладіть начинку: салат, огірок, м'ясо, сир.", "5)Загорніть лаваш у рулет, підгортаючи краї.", "6)Обсмажте шаурму на сухій сковороді до рум’яної скоринки" });
            listBox2.Location = new Point(6, 307);
            listBox2.Name = "listBox2";
            listBox2.Size = new Size(516, 220);
            listBox2.TabIndex = 170;
            // 
            // label2
            // 
            ...
            label2.Location = new Point(325, 43);
            label2.Name = "label2";
            ...
            pictureBox1.Size = new Size(304, 201);
            ...
            listBox1.Items.AddRange(new object[] { "Лаваш – 2 листи", "Салат – 4 листки", "Огірок – 1 шт.", "М’ясо– 1 шматок", "Соус ", "Сир " });
            listBox1.Location = new Point(328, 78);
            listBox1.Name = "listBox1";
            listBox1.Size = new Size(208, 182);
            listBox1.TabIndex = 166;
            // 
            // back
            // 
            ...
            back.Location = new Point(15, 541);
            back.Name = "back";
            ...
            next_Page.Location = new Point(420, 541);
            next_Page.Name = "next_Page";
            next_Page.Size = new Size(99, 39);
            next_Page.TabIndex = 164;
            next_Page.Text = "Далі";
            ...
            button3.Location = new Point(286, 541);
            ...
            button2.Location = new Point(153, 541);
            button2.Name = "button2";
            button2.Size = new Size(99, 39);
            button2.TabIndex = 172;
            button2.Text = "Меню";
            ...
            // cook
            // 
            cook.Location = new Point(325, 278);
            cook.Name = "cook";
