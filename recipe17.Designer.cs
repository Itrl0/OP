namespace OP
{
    partial class recipe17
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(recipe17));
            label3 = new Label();
            ...
            listBox2.Items.AddRange(new object[] { "1)Підсмажте шматочки хліба на сковороді або у тостері.", "2)Розімніть авокадо виделкою до стану пасти.", "3)Зваріть яйце некруто або пашот.", "4)Намажте тост авокадо, покладіть зверху яйце.", "5)Посоліть і поперчіть за смаком.", "6)Подавайте відразу, поки тост хрусткий." });
            listBox2.Location = new Point(4, 307);
            listBox2.Name = "listBox2";
            listBox2.Size = new Size(516, 220);
            listBox2.TabIndex = 114;
            // 
            // label2
            // 
            ...
            label1.Name = "label1";
            label1.Size = new Size(447, 33);
            label1.TabIndex = 112;
            label1.Text = "Назва:   Тости з авокадо та яйцем";
            // 
            // pictureBox1
            // 
            pictureBox1.Image = (Image)resources.GetObject("pictureBox1.Image");
            pictureBox1.Location = new Point(20, 78);
            ...
            listBox1.Items.AddRange(new object[] { "Хліб – 2 скибки", "Авокадо – 1 шт.", "Яйце – 1 шт.", "Сіль" });
            ...
            button3.Location = new Point(279, 541);
            ...
            button2.Location = new Point(146, 541);
