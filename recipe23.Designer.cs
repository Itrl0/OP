namespace OP
{
    partial class recipe23
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(recipe23));
            label3 = new Label();
            ...
            listBox2.Items.AddRange(new object[] { "1)Замісіть тісто з борошна, яйця і солі.", "2)Розкачайте тісто і виріжте кружечки.", "3)У кожен кружечок викладіть трохи фаршу.", "4)Защипніть краї, сформувавши пельмені.", "5)Відваріть у підсоленій воді до спливання плюс ще 3", " хвилини.", "6)Подавайте з вершковим маслом або сметаною." });
            listBox2.Location = new Point(3, 307);
            listBox2.Name = "listBox2";
            listBox2.Size = new Size(516, 220);
            listBox2.TabIndex = 154;
            // 
            // label2
            // 
            ...
            pictureBox1.Size = new Size(232, 201);
            ...
            listBox1.Items.AddRange(new object[] { "Фарш – 1 шматок ", "Борошно ", "Яйце – 1 шт.", "Сіль ", "Вода" });
            ...
            // cook
            // 
            cook.Location = new Point(322, 278);
            cook.Name = "cook";
