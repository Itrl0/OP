namespace OP
{
    partial class recipe13
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(recipe13));
            back = new Button();
            ...
            listBox2.Items.AddRange(new object[] { "1)Збийте яйця в глибокій мисці з дрібкою солі.", "2)Наріжте помідори, перець і цибулю дрібними кубиками.", "3)Обсмажте овочі на олії кілька хвилин до м’якості.", "4)Влийте збиті яйця до овочів на сковороду.", "5)Готуйте омлет на середньому вогні під кришкою, поки він ", "не схопиться.", "6)Перекладіть омлет на тарілку і подавайте гарячим." });
            listBox2.Location = new Point(3, 307);
            listBox2.Name = "listBox2";
            listBox2.Size = new Size(516, 220);
            listBox2.TabIndex = 90;
            // 
            // label2
            // 
            ...
            label2.Location = new Point(322, 43);
            label2.Name = "label2";
            ...
            label1.TabIndex = 88;
            label1.Text = "Назва: Омлет з овочами";
            // 
            // pictureBox1
            // 
            ...
            listBox1.Items.AddRange(new object[] { "Яйця – 3 шт.", "Помідори – 1 шт.", "Перець – 1 шт.", "Цибуля – 1 шт.", "Зелень - 1 шт.", "Сіль", "Олія" });
            listBox1.Location = new Point(325, 78);
            ...
            // cook
            // 
            cook.Location = new Point(347, 278);
            cook.Name = "cook";
