namespace OP
{
    partial class recipe22
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(recipe22));
            label3 = new Label();
            ...
            label3.Location = new Point(143, 275);
            label3.Name = "label3";
            ...
            listBox2.Items.AddRange(new object[] { "1)Змішайте фарш з сіллю і спеціями, додайте трохи хліба.", "2)Сформуйте з фаршу ковбаски, всередину покладіть", " шматочок масла.", "3)Обкачайте котлети в паніровці.", "4)Обсмажте їх на сильному вогні до рум'яної скоринки.", "5)Потім доведіть до готовності у духовці при 180°С 10–15", " хвилин.", "6)Подавайте гарячими з гарніром." });
            listBox2.Location = new Point(4, 307);
            listBox2.Name = "listBox2";
            listBox2.Size = new Size(516, 220);
            listBox2.TabIndex = 146;
            // 
            // label2
            // 
            ...
            label1.TabIndex = 144;
            label1.Text = "Назва: Котлета по-київськи";
            // 
            // pictureBox1
            // 
            ...
            pictureBox1.Size = new Size(290, 201);
            ...
            listBox1.Items.AddRange(new object[] { "Фарш – 2 шматка", "Паніровка", "Хліб – 1 скибка", "Олія", "Сіль" });
            listBox1.Location = new Point(326, 78);
            listBox1.Name = "listBox1";
            listBox1.Size = new Size(208, 182);
            listBox1.TabIndex = 142;
            // 
            // back
            // 
            ...
            back.Location = new Point(13, 541);
            back.Name = "back";
            ...
            next_Page.Location = new Point(418, 541);
            next_Page.Name = "next_Page";
            next_Page.Size = new Size(99, 39);
            next_Page.TabIndex = 140;
            next_Page.Text = "Далі";
            ...
            // cook
            // 
            cook.Location = new Point(323, 278);
            cook.Name = "cook";
