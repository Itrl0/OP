namespace OP
{
    partial class recipe55
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(recipe55));
            back = new Button();
            ...
            listBox2.Items.AddRange(new object[] { "1)Промийте гречку, залийте водою, посоліть і варіть до", " готовності (15–20 хв).", "2)Наріжте цибулю і гриби.", "3)Обсмажте спочатку цибулю, потім додайте гриби, смажте", " до золотистості.", "4)Коли гречка приготується, додайте до неї гриби з ", "цибулею.", "5)Перемішайте, при необхідності досоліть.", "6)Можна подати з вершковим маслом або соусом." });
            listBox2.Location = new Point(12, 317);
            ...
            label2.Location = new Point(331, 43);
            label2.Name = "label2";
            ...
            label1.TabIndex = 40;
            label1.Text = "Назва: Гречка з грибами";
            // 
            // pictureBox1
            // 
            pictureBox1.Image = (Image)resources.GetObject("pictureBox1.Image");
            pictureBox1.Location = new Point(28, 78);
            ...
            listBox1.Items.AddRange(new object[] { "Гречка ", "Шампіньйони – 5–6 шт.", "Цибуля – 1 шт.", "Олія", "Сіль " });
            listBox1.Location = new Point(334, 78);
            ...
            // cook
            // 
            cook.Location = new Point(333, 275);
            cook.Name = "cook";
