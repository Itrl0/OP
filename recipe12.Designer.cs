namespace OP
{
    partial class recipe12
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(recipe12));
            ...
            listBox2.Items.AddRange(new object[] { "1)Змішайте домашній сир, яйце, цукор і борошно до ", "однорідної маси.", "2)Сформуйте з тіста невеликі коржики.", "3)Обваляйте їх у борошні або манці.", "4)Обсмажте сирники на олії на середньому вогні до", " золотистої скоринки з обох боків.", "5)Потім накрийте кришкою і трохи потоміть.", "6)Подавайте сирники зі сметаною або варенням." });
            listBox2.Location = new Point(10, 307);
            listBox2.Name = "listBox2";
            listBox2.Size = new Size(516, 220);
            listBox2.TabIndex = 84;
            // 
            // label2
            // 
            ...
            listBox1.Items.AddRange(new object[] { "Домашній сир – 1 пачка", "Яйце – 1 шт.", "Цукор", "Борошно", "Олія " });
            listBox1.Location = new Point(332, 78);
            listBox1.Name = "listBox1";
            listBox1.Size = new Size(208, 182);
            listBox1.TabIndex = 80;
            // 
            // button3
            // 
