namespace OP
{
    partial class recipe10
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(recipe10));
            ...
            listBox2.Items.AddRange(new object[] { "1)Наріжте хліб скибочками.", "2)Намажте кожну скибку тонким шаром масла.", "3)Покладіть зверху шматочок ковбаси.", "4)Додайте зверху шматочок сиру.", "5)За бажанням можна злегка підрум'янити бутерброди ", "в духовці.", "6)Подавайте теплими або холодними." });
            ...
            label1.TabIndex = 70;
            label1.Text = "Назва: Бутерброди з ковбасою та сиром";
            // 
            // pictureBox1
            // 
            ...
            listBox1.Items.AddRange(new object[] { "Хліб – 4 скибки", "Ковбаса", "Сир", "Масло " });
            ...
            // cook
            // 
            cook.Location = new Point(409, 278);
            cook.Name = "cook";
            cook.Size = new Size(107, 29);
            cook.TabIndex = 76;
