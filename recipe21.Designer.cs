namespace OP
{
    partial class recipe21
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(recipe21));
            label3 = new Label();
            ...
            listBox2.Items.AddRange(new object[] { "1)Наріжте м'ясо порційними шматками.", "2)Відбийте м'ясо кухонним молоточком з обох боків.", "3)Посоліть, поперчіть і залиште на 10 хвилин.", "4)Збийте яйце, підготуйте окремо борошно.", "5)Обмакніть м'ясо в яйце, потім у борошно.", "6)Обсмажте відбивні на розігрітій олії до золотистої скоринки." });
            ...
            listBox1.Items.AddRange(new object[] { "М'ясо – 4 шматки", "Яйце – 1 шт.", "Борошно", "Сіль", "Олія " });
            ...
            button3.Location = new Point(280, 541);
            ...
            button2.Location = new Point(147, 541);
