namespace OP
{
    partial class recipe16
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(recipe16));
            label3 = new Label();
            ...
            label3.Location = new Point(144, 275);
            label3.Name = "label3";
            ...
            listBox2.Items.AddRange(new object[] { "1)Очистіть і наріжте картоплю, моркву і цибулю кубиками.", "2)Закип’ятіть воду і відправте овочі варитися.", "3)Зробіть фрикадельки з фаршу, додавши трохи солі та", " спецій.", "4)Додайте фрикадельки до овочів через 10 хвилин після ", "закипання.", "5)Варіть суп до готовності м’яса та овочів.", "6)Посипте зверху зеленню перед подачею." });
            listBox2.Location = new Point(5, 307);
            ...
            label1.Name = "label1";
            label1.Size = new Size(396, 33);
            label1.TabIndex = 104;
            label1.Text = "Назва:   Суп з фрикадельками";
            // 
            // pictureBox1
            // 
            ...
            listBox1.Items.AddRange(new object[] { "Картопля – 3 шт.", "Фарш - 2 шматка", "Морква – 1 шт.", "Цибуля – 1 шт.", "Зелень – 1 шт.", "Сіль" });
            listBox1.Location = new Point(327, 78);
            ...
            button3.Location = new Point(283, 541);
            ...
            button2.Location = new Point(150, 541);
            ...
            // cook
            // 
            cook.Location = new Point(327, 278);
            cook.Name = "cook";
