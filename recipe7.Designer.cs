namespace OP
{
    partial class recipe7
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(recipe7));
            back = new Button();
            ...
            back.Location = new Point(12, 555);
            back.Name = "back";
            ...
            next_Page.Location = new Point(418, 555);
            next_Page.Name = "next_Page";
            next_Page.Size = new Size(99, 39);
            next_Page.TabIndex = 25;
            next_Page.Text = "Далі";
            ...
            listBox2.Items.AddRange(new object[] { "1)Почистіть картоплю і наріжте її середніми шматочками.", "2)Відваріть картоплю у підсоленій воді до м’якості ", "(приблизно 20 хвилин).", "3)Злийте воду і залиште картоплю на кілька хвилин без", " кришки, щоб випарувалася зайва волога.", "4)Додайте тепле молоко та шматочок масла до картоплі.", "5)Розімніть картоплю товкачем або міксером до однорідної", " маси.", "6)Посоліть за смаком і ще раз добре перемішайте перед", " подачею." });
            listBox2.Location = new Point(10, 307);
            listBox2.Name = "listBox2";
            listBox2.Size = new Size(516, 242);
            ...
            label1.TabIndex = 52;
            label1.Text = "Назва: Картопляне пюре";
            // 
            // pictureBox1
            // 
            ...
            listBox1.Items.AddRange(new object[] { "Картопля – 5 шт.", "Молоко ", "Масло", "Сіль" });
            listBox1.Location = new Point(332, 78);
            ...
            button3.Location = new Point(280, 555);
            ...
            button2.Location = new Point(147, 555);
            ...
            // cook
            // 
            cook.Location = new Point(332, 278);
            cook.Name = "cook";
