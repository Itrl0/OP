namespace OP
{
    partial class recipe6
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(recipe6));
            back = new Button();
            ...
            listBox2.Items.AddRange(new object[] { "1)Зваріть макарони в підсоленій воді до стану al dente.", "2)Цибулю дрібно наріжте, обсмажте ", "3)Додайте фарш, смажте до готовності", "4)Посоліть додайте трохи томатної пасти.", "5)Додайте відварені макарони, все добре перемішайте.", "6)Смажте ще 2–3 хвилини, щоб страви \"подружилися\"." });
            listBox2.Location = new Point(9, 307);
            ...
            label1.TabIndex = 46;
            label1.Text = "Назва: Макарони по-флотськи";
            // 
            // pictureBox1
            // 
            ...
            listBox1.Items.AddRange(new object[] { "Макарони", "Фарш – 1 шматок ", "Цибуля – 1 шт.", "Сіль", "Олія", "Шампінйьони - 6 шт." });
            listBox1.Location = new Point(331, 78);
            ...
            // cook
            // 
            cook.Location = new Point(331, 278);
            cook.Name = "cook";
