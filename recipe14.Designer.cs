namespace OP
{
    partial class recipe14
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(recipe14));
            label3 = new Label();
            ...
            listBox2.Items.AddRange(new object[] { "1)Наріжте м'ясо невеликими шматочками і обсмажте", " до готовності.", "2)Порвіть листя салату руками на великі шматки.", "3)Змішайте салат із сухариками і тертим сиром.", "4)Додайте обсмажене м'ясо.", "5)Заправте майонезом", "6)Акуратно перемішайте і одразу подавайте." });
            listBox2.Location = new Point(4, 307);
            listBox2.Name = "listBox2";
            listBox2.Size = new Size(516, 220);
            listBox2.TabIndex = 98;
            // 
            // label2
            // 
            ...
            listBox1.Items.AddRange(new object[] { "М'ясо – 1 шматок", "Листя салату – 5 шт.", "Сухарики", "Сир", "Майонез " });
            ...
            button3.Location = new Point(281, 541);
            ...
            button2.Location = new Point(148, 541);
